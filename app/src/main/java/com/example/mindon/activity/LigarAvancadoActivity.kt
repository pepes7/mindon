...
class LigarAvancadoActivity : AppCompatActivity() {
    private var cont = 1
    ...
    fun inicializar(){
       txt_1.text = "1) He said he was feeling the same"
       txt_2.text = "2) Do your best, and good things will follow"
       txt_3.text = "3) Each day brings its own challenges"
       txt_4.text = "4) I don't even recognize which is which!"
       txt_5.text = "5) What do you think of these Common Portuguese Words?"

       txt_a.text = "a) Faça o seu melhor, e coisas boas virão a seguir"
       txt_b.text = "b) Ele disse que estava sentindo o mesmo"
       txt_c.text = "c) Eu nem sei qual é qual!"
       txt_d.text = "d) O que você achou destas Palavras Comuns em Português?"
       txt_e.text = "e) Cada dia traz seus próprios desafios"
    }
    fun carregar(){
