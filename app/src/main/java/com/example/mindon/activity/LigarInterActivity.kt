...
class LigarInterActivity : AppCompatActivity() {
    private var cont = 1
    ...
    fun inicializar(){
        txt_1.text = "1) I will certainly go to your birthday party"
        txt_2.text = "2) I may call them"
        txt_3.text = "3) Might I borrow your calculator?"
        txt_4.text = "4) I used to swim every day"
        txt_5.text = "5) Would you play?"

        txt_a.text = "a) Eu posso ligar para eles"
        txt_b.text = "b) Certamente eu vou à sua festa de aniversário"
        txt_c.text = "c) Eu costumava nadar todos os dias"
        txt_d.text = "d) Você jogaria?"
        txt_e.text = "e) Posso pegar emprestada sua calculadora?"
    }
